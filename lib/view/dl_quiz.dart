...
class DlQuiz extends StatefulWidget {
  const DlQuiz({super.key});

  @override
  State<DlQuiz> createState() => _DlQuizState();
}

class _DlQuizState extends State<DlQuiz> {
  int currentQuestionIndex = 0;
  int correctAnswers = 0;
  String? selectedAnswer;

  void checkAnswer(String? selectedOption) {
    final controller = context.read<DlTestQuestionController>();
  ...
  Widget build(BuildContext context) {
    final controller = context.watch<DlTestQuestionController>();
