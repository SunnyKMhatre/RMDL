...
class MsQuiz extends StatefulWidget {
  const MsQuiz({super.key});

  @override
  State<MsQuiz> createState() => _MsQuizState();
}

class _MsQuizState extends State<MsQuiz> {
  int currentQuestionIndex = 0;
  int correctAnswers = 0;
  String? selectedAnswer;

  void checkAnswer(String? selectedOption) {
    final controller = context.read<MsTestQuestionController>();
  ...
  Widget build(BuildContext context) {
    final controller = context.watch<MsTestQuestionController>();
