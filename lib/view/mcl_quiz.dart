...
class MclQuiz extends StatefulWidget {
  const MclQuiz({super.key});

  @override
  State<MclQuiz> createState() => _MclQuizState();
}

class _MclQuizState extends State<MclQuiz> {
  int currentQuestionIndex = 0;
  int correctAnswers = 0;
  String? selectedAnswer;

  void checkAnswer(String? selectedOption) {
    final controller = context.read<MclTestQuestionController>();
  ...
  Widget build(BuildContext context) {
    final controller = context.watch<MclTestQuestionController>();
