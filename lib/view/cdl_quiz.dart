...
class CdlQuiz extends StatefulWidget {
  const CdlQuiz({super.key});

  @override
  State<CdlQuiz> createState() => _CdlQuizState();
}

class _CdlQuizState extends State<CdlQuiz> {
  int currentQuestionIndex = 0;
  int correctAnswers = 0;
  String? selectedAnswer;

  void checkAnswer(String? selectedOption) {
    final controller = context.read<CdlTestQuestionController>();
  ...
  Widget build(BuildContext context) {
    final controller = context.watch<CdlTestQuestionController>();
